...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-FireflyMobileApp/JVFloatLabeledTextField.framework"
  ...
  install_framework "Pods-FireflyMobileApp/Moya.framework"
  install_framework "Pods-FireflyMobileApp/RSDayFlow.framework"
  install_framework "Pods-FireflyMobileApp/Realm.framework"
  install_framework "Pods-FireflyMobileApp/RealmSwift.framework"
  install_framework "Pods-FireflyMobileApp/Result.framework"
  install_framework "Pods-FireflyMobileApp/SCLAlertView.framework"
  install_framework "Pods-FireflyMobileApp/SlideMenuControllerSwift.framework"
