...
public enum FireFlyAPI {
    ...
    case PassengerDetail(AnyObject, AnyObject, String, String, String, String, String)
...
extension FireFlyAPI : TargetType {
    ...
    public var parameters: [String: AnyObject]? {
        ...
        case .PassengerDetail(let adult, let infant, let bookId, let signature, let flightType, let email, let familyAndFriend):
            return ["passengers" : adult, "infants" : infant, "booking_id" : bookId, "signature" : signature, "flight_type" : flightType, "user_email" : email, "freind_and_family" : familyAndFriend]
