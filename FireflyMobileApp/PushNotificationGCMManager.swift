//
//  PushNotificationGCMManager.swift
//  FireflyMobileApp
//
...
class PushNotificationGCMManager: NSObject, GGLInstanceIDDelegate, GCMReceiverDelegate {

    static let sharedInstance = PushNotificationGCMManager()
